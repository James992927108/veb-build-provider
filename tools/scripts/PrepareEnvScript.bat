...
@REM Intel M9
Set TOOLS_DIR=C:\VEB\Aptio_5.x_TOOLS_JRE_59_x64\BuildTools
Set JAVA_HOME=C:\VEB\Aptio_5.x_TOOLS_JRE_59_x64\VisualeBios\zulu\bin
Set MSVC_ROOT=C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools
Set PYTHON_COMMAND=C:\Python\Python311\python.exe
